...
import ProductionGridCard from '../../../../../features/productions/components/cards/ProductionGridCard'
...
const renderGridCardWithRoutes = (ui: ReactElement) =>
  render(
...
describe('ProductionGridCard', () => {
  ...
  it('does not render nested anchors for chips inside the production card link', () => {
    ...
    renderGridCard({ production, selectedGenreIds: undefined, selectedTagIds: undefined })
  ...
  it('navigates genre chip clicks to the archive instead of the production detail page', () => {
    const production = baseProduction({
      id: 7,
      genres: [minimalGenre(22, 'Genre')],
    })

    renderGridCardWithRoutes(<ProductionGridCard production={production} />)
  ...
  it('sorts selected genres before unselected genres', () => {
    ...
    renderGridCard({ production, selectedGenreIds: [2] })
