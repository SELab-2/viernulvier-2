...
const getFileTypeLabel = (mediaFile: MediaFile, t: ReturnType<typeof useTranslation>['t']): string => {
            ...
            >
                ...
                >
                    <Stack spacing={1.25} sx={{ width: '100%' }}>
                        ...
                        >
                            <Chip size="small" icon={<DescriptionIcon />} label={getFileTypeLabel(mediaFile, t)} />
