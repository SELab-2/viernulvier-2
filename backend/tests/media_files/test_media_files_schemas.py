...
def test_request_examples_only_include_expected_payloads() -> None:
    assert schemas._MEDIA_FILE_INPUT.value == {"file": "<binary file>"}
    assert schemas._MEDIA_FILE_PARTIAL_INPUT.value == {"external_id": "print-archive-2026-001"}
    assert schemas._MEDIA_FILE_PUT_INPUT.value == {"file": "<binary file>"}
