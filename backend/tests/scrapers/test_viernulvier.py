...
# =============================================================================
# Coverage Tests for Missing Lines 245, 262, 271, 284, 293, 301, 344, 414, 472, 477, 479, 648
# =============================================================================


def test_extract_external_id_from_url_with_int():
    """Test _extract_external_id_from_url with an integer value (line 284)."""
    assert viernulvier._extract_external_id_from_url(42) == "42"


def test_extract_external_id_from_url_with_dict_external_id_fallback():
    """Test _extract_external_id_from_url with dict using external_id fallback (line 293)."""
...
def test_extract_external_id_from_url_with_dict_id_fallback():
    """Test _extract_external_id_from_url with dict using id fallback (line 301)."""
...
def test_parse_field_value_datetime_with_negative_year():
    """Test _parse_field_value handles negative year by stripping minus (line 245)."""
...
def test_parse_field_value_datetime_with_year_zero():
    """Test _parse_field_value converts year 0000 to 1970 (line 262)."""
    field = models.DateTimeField()
...
def test_parse_field_value_datefield_string():
    """Test _parse_field_value with DateField and string value (line 271)."""
...
def test_extract_lookup_value_with_id_fallback():
    """Test _extract_lookup_value uses id fallback when api_id_key missing (line 414)."""
...
def test_extract_lookup_value_dict_with_id():
    """Test _extract_lookup_value extracts from nested dict id field (line 472)."""
    config = viernulvier.ModelSyncConfig(api_id_key="@id", lookup_field="external_id")
...
def test_extract_lookup_value_strips_whitespace():
    """Test _extract_lookup_value strips whitespace from value (line 477)."""
    config = viernulvier.ModelSyncConfig(api_id_key="@id", lookup_field="external_id")
...
def test_extract_lookup_value_empty_string_after_strip():
    """Test _extract_lookup_value returns empty string after strip (line 479)."""
    config = viernulvier.ModelSyncConfig(api_id_key="@id", lookup_field="external_id")
    item = {"@id": "   "}
    result = viernulvier._extract_lookup_value(item, config)
...
def test_sync_m2m_with_non_dict_raw_item_extra_fields():
    """Test _sync_m2m handles non-dict raw_item in extra_fields check (line 648)."""
    parent = Mock(pk=1)
    related_model = Mock()
    through_model = Mock()
