...
def test_event_price_unique_per_event_price_rank_and_price():
...
def test_event_price_same_rank_different_price_is_allowed():
...
def test_event_price_same_price_different_rank_is_allowed():
...
def test_event_price_set_null_when_price_deleted():
...
def test_event_price_stores_price_fk():
...
def test_event_price_price_fk_can_be_null():
